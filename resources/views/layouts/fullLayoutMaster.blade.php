...
<head>
  ...
  <link rel="apple-touch-icon" href="{{ asset('images/icons/logo-fay.png') }}">
  <link rel="shortcut icon" type="image/x-icon" href="{{ asset('images/logo/Icono-Fay-Web-Pestana.jpg') }}">
